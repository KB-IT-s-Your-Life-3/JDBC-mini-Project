...
public class Asset {
	...
	public Asset(int dongId, String assetName, String createdAt, int price, float area, int constructedYear,
			int assetId, int isDealed) {
		this.dongId = dongId;
		this.assetName = assetName;
		this.createdAt = createdAt;
		this.price = price;
	...
	public String toString() {
		return "Asset [assetId=" + assetId + ", constructedYear=" + constructedYear + ", assetName=" + assetName
				+ ", gu=" + gu + ", dong=" + dong + ", cereatedAt=" + createdAt + ", regionCode=" + regionCode
				+ ", price=" + price + ", isDealed=" + isDealed + ", area=" + area + "]";
	}
